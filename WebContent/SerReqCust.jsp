...
<%@ page import="model.SerReqCust" %>    
    

<%
	/********Java Code*************/

List<SerReqCust> list=(List<SerReqCust>)request.getAttribute("list");
%>    
<!DOCTYPE html>

<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">

<title>Service Request - User</title>
              ...
              <div class="fl-header-right" >
                <div class="fl-links">
                    ...
                    <div class="fl-nav-links">
                      <ul class="links">
                        <li><a class="active" href="SignoutServlet">Sign Out</a></li>
                        </ul>
                    </div>
                  </div>
                </div>
...
<center>
 ...
 <form method="get" action="SerTypeController">
		<center>
            
            <b> Vehicle Type:</b>
            <%
					try{
						for(SerReqCust p:list){
					
				%>
				<input type = "radio" name="vehtyp" value="<%=p.getVehtyp() %>" required/><%=p.getVehtyp() %>&nbsp;
			<%}}catch(Exception e){e.getStackTrace();} %>
    <button style="padding: 5px 50px" onclick="Submit">Next</button>
