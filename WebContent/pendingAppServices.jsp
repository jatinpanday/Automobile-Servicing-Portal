<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="model.PendingAppServices" %>
    
<%
	/********Java Code*************/

List<PendingAppServices> list=(List<PendingAppServices>)request.getAttribute("list");
%>
<!DOCTYPE html>

<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">

<title>Pending Services - Admin</title>
...
<form method="get" action="AppChangeServlet">
...
<a href="http://themesground.com/motocart-demo/V1/#" id="toTop" style="display: block;"><span id="toTopHover"></span></a>
</body>
</html>
