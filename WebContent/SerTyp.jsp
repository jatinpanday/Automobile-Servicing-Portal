...
<%@ page import="model.SerType" %>    
    

<%
	/********Java Code*************/

List<SerType> list=(List<SerType>)request.getAttribute("list");
%>    
<!DOCTYPE html>
...
<center>
 ...
 <form method="get" action="FinalCustServlet">
		<center>
            ...
            <%
				...
				%>
				<input type="radio" name="servicename" value="<%=p.getSername() %>" required/><%=p.getSername() %>&nbsp;
 ...
 <form method="get" action="FinalCustServlet">
		<center>
            ...
            <%
				...
				%>
				<input type="radio" name="servicename" value="<%=p.getSername() %>"/><%=p.getSername() %>&nbsp;
			<%}}catch(Exception e){e.getStackTrace();} %>
